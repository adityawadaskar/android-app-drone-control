...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener
{
    ...
    private static float[] joystick_values = {0f, 0f, 0f, 0f};
        ...
        if(v.equals(this))
        {
            ...
            if(e.getAction() != e.ACTION_UP)
            {
                ...
                if(displacement < baseRadius)
                {
                    ...
                    joystick_values[index1] = (e.getX() - centerX)/baseRadius;
                    joystick_values[index2] = (e.getY() - centerY)/baseRadius;
                }
                else
                {
                    ...
                    joystick_values[index1] = (constrainedX-centerX)/baseRadius;
                    joystick_values[index2] = (constrainedY-centerY)/baseRadius;
                }
            }
            else if (id == R.id.joystickRight) {
                drawJoystick(centerX, centerY);
                joystick_values[index1] = 0;
                joystick_values[index2] = 0;
            }
    ...
    public float[] getJoystick_values() {
